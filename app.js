...
// Then pass the below theEnd function into an invocation of everyXsecsForYsecs with 1000 interval time an 5000 duration time.
// What do you expect to happen?

function everyXsecsForYsecs(func, interval, duration) {
    var t = setInterval(func, interval);
    setTimeout(() => {
        clearInterval(t)
    }, duration)
}
...
// When the returned function is invoked, it should log to the console all of the numbers between 1
// and the target number, spaced apart by 'wait' milliseconds.
...
// Write a function called debounce that accepts a function and returns a new function that only allows invocation 
// of the given function after interval milliseconds have passed since the last time the returned function ran.
    ...
    function closureFn() {
        ...
        if (!hasRan) {
            ...
            if (counter < interval) {
                ...
                console.log('vrijednost countera', counter)
                counter = 0;
                clearInterval(id);
                id = setInterval(() => counter++, 1);
                return undefined;
